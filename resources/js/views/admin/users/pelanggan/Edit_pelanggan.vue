            ...
            <div class="col-md-8 offset-md-2">
                <form  method="post" action="#" @submit.prevent="update" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex">
                        <input :type="passwordField" class="form-control" v-model="form.password" value="">
                     ...
                     <div class="form-group">
                        ...
                        <select class="form-control" @change="selectedRt"  id="exampleFormControlSelect1"> 
                            <option :value="form.id_alamat" v-text="form.id_alamat"></option>
                        
                            <template  class="form-control" id="exampleFormControlSelect1" >
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Anda yakin ingin hapus pelanggan</p>
                </div>
...
export default {
    ...
    methods:{
        ...
        async getPelanggan(){
            let response= await axios.get(`http://127.0.0.1:8000/api/pelanggans/${this.$route.params.pelangganNama}`);
        ...
        async update(){
             ...
             this.form['id_alamat'] = this.selected || this.form.id_alamat

            let response= await axios.patch(`http://127.0.0.1:8000/api/pelanggans/${this.$route.params.pelangganNama}/edit`, this.form);
